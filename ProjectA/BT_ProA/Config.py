...
from BT_ProA.Exec import exec_
from BT_ProA.Gcn import trainer, Net
...
def fromConfigFile(gcn_mode, config_version):
    ...
    for i in [i[0] for i in sorted_configs]:
        ...
        with open(filepath) as cfp:
            ...
            line = cfp.readline()
            while line:
                # transform the line to a list of numbers
